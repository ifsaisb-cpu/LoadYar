...
@Module({
  imports: [
    ...
    TypeOrmModule.forRoot({
      ...
      entities: [Tenant, User, TenantSubscription, TenantConfiguration, ImportJob, OnboardingProgress, BillingEvent],
      synchronize: true,
      logging: process.env.DB_LOGGING === 'true',
    }),
    TypeOrmModule.forFeature([Tenant, User, TenantSubscription, TenantConfiguration, ImportJob, OnboardingProgress, BillingEvent]),
    PassportModule,
    JwtModule.register({
